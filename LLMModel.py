    ...
    def get_llm_items(self,query):
        ...
        completion = OpenAI.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Respond in a numbered list of 10 items that matches the context of toys and stationery retail stores, without numbers. If no items found return an empty list."
                },
